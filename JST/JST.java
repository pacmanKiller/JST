...
import Tutor.Recorder;

public class AllRightJST {
    ...
    public static void JST_3_2_4(int x){
        ...
        public void JST_4_1_6(){
            int x = (Integer) Recorder.record(2);
        }
        ...
        public void JST_4_1_7(){
            int x = (Integer) Recorder.record(1);
            while (x < 12)
                x = (Integer) Recorder.record(2);
            Recorder.record(x);
        }
